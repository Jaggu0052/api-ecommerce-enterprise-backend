-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('SUPER_ADMIN', 'ADMIN', 'MANAGER', 'EMPLOYEE', 'CUSTOMER');
...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('COD', 'CARD', 'UPI', 'WALLET', 'NETBANKING');
...
-- CreateEnum
CREATE TYPE "OTPType" AS ENUM ('EMAIL', 'PHONE', 'WHATSAPP', 'LOGIN');
