...
export class EmployeesController {
  constructor(@Optional() private readonly service: EmployeesService) {}
  @Roles('SUPER_ADMIN', 'ADMIN') @Post() create(@Body() dto: Record<string, unknown>) { return this.service.create(dto) }
