...
export class ShipmentsController {
  constructor(@Optional() private readonly service: ShipmentsService) {}
  ...
  @Roles('SUPER_ADMIN', 'ADMIN', 'MANAGER', 'EMPLOYEE') @Patch(':id') update(@Param('id') id: string, @Body() dto: Record<string, unknown>) { return this.service.update(id, dto) }
