...
export class CustomerAddressController {
  constructor(@Optional() private readonly service: CustomerAddressService) {}
  ...
  @Roles('SUPER_ADMIN', 'ADMIN', 'CUSTOMER') @Patch(':id') update(@Param('id') id: string, @Body() dto: Record<string, unknown>) { return this.service.update(id, dto) }
  @Roles('SUPER_ADMIN', 'ADMIN', 'CUSTOMER') @Delete(':id') remove(@Param('id') id: string) { return this.service.remove(id) }
}
