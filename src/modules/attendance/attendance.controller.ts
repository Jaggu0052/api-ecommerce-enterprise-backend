...
export class AttendanceController {
  constructor(@Optional() private readonly service: AttendanceService) {}
  @Roles('SUPER_ADMIN', 'ADMIN', 'MANAGER', 'EMPLOYEE') @Post() create(@Body() dto: Record<string, unknown>) { return this.service.create(dto) }
  @Roles('SUPER_ADMIN', 'ADMIN', 'MANAGER') @Get() findAll(@Query() query: PaginationQueryDto) { return this.service.findAll(query) }
  @Roles('SUPER_ADMIN', 'ADMIN', 'MANAGER', 'EMPLOYEE') @Get(':id') findOne(@Param('id') id: string) { return this.service.findOne(id) }
